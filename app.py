...
def model_prediction(test_image):
    # Load model without compiling to avoid batch_shape error
...
# ------------------------------
    ...
    The dataset is divided into 80/20 ratio of training and validation set preserving the directory structure.  
    A new directory containing 33 test images is created for prediction purposes.
